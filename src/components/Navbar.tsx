      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between gap-4">
          ...
          <nav className="hidden md:flex items-center justify-center space-x-6 w-full">
            <Link to="/" className="transition-colors text-white/70 hover:text-white">
              Home
            </Link>
            <Link to="/products" className="transition-colors text-white/70 hover:text-white">
              Products
            </Link>
            <Link to="/about" className="transition-colors text-white/70 hover:text-white">
              About
            </Link>
            <Link to="/contact" className="transition-colors text-white/70 hover:text-white">
              Contact
            </Link>
          </nav>
          ...
          <div className="hidden md:flex items-center space-x-4">
            <form onSubmit={handleSearch} className="relative">
              ...
              <button
                type="submit"
                className="absolute right-3 top-2.5 transition-colors text-white/60 hover:text-neon-blue"
              >
                <Search size={16} />
              </button>
            </form>
      ...
      >
        <div className="container mx-auto px-4 space-y-6">
          <nav className="flex flex-col space-y-4">
            <Link to="/" className="py-2 transition-colors text-white/70 hover:text-white">
              Home
            </Link>
            <Link to="/products" className="py-2 transition-colors text-white/70 hover:text-white">
              Products
            </Link>
            <Link to="/about" className="py-2 transition-colors text-white/70 hover:text-white">
              About
            </Link>
            <Link to="/contact" className="py-2 transition-colors text-white/70 hover:text-white">
              Contact
            </Link>
          </nav>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between">
              {isAuthenticated ? (
                <Link
                  to="/profile"
                  className="p-2 flex items-center gap-2 transition-colors text-white/70 hover:text-neon-blue"
                >
                  <User size={20} />
                  <span>Profile</span>
                </Link>
