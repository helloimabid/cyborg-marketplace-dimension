      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link to="/" className="transition-colors text-white/70 hover:text-white">Home</Link>
            <Link to="/products" className="transition-colors text-white/70 hover:text-white">Products</Link>
            <Link to="/about" className="transition-colors text-white/70 hover:text-white">About</Link>
            <Link to="/contact" className="transition-colors text-white/70 hover:text-white">Contact</Link>
          </nav>
      ...
      <div className={`md:hidden absolute w-full transition-all duration-300 
        ...
        <div className="container mx-auto px-4 space-y-6">
          <nav className="flex flex-col space-y-4">
            <Link to="/" className="py-2 transition-colors text-white/70 hover:text-white">Home</Link>
            <Link to="/products" className="py-2 transition-colors text-white/70 hover:text-white">Products</Link>
            <Link to="/about" className="py-2 transition-colors text-white/70 hover:text-white">About</Link>
            <Link to="/contact" className="py-2 transition-colors text-white/70 hover:text-white">Contact</Link>
          </nav>
